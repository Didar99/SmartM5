...
public class PrefConfig {
    ...
    private static final String PREF_STOVE2_KEY = "pref_stove_key";
    ...
    private static final String PREF_AIR_TEMP_KEY = "pref_air_temp_key";
    private static final String PREF_SW_LAMP_KEY = "pref_sw_lamp_key";
    private static final String PREF_ELECTRIC_DEVICES_KEY = "pref_electric_devices_key";
    private static final String PREF_KITCHEN_STATE_KEY = "pref_kitchen_state_key";
    private static final String PREF_DIMMER_STATE_KEY = "pref_dimmer_state_key";
    private static final String PREF_STOVE_IP_KEY = "pref_stove_ip_key";
  ...
  // for IP address
    ...
    // for Stove 1
    public static void saveStateStove2(Context context, int stove2) {
        SharedPreferences pref = context.getSharedPreferences(MY_PREFERENCE_NAME, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = pref.edit();
        editor.putInt(PREF_STOVE2_KEY, stove2);
        editor.apply();
    }
    public static int loadStateStove2(Context context) {
        SharedPreferences pref = context.getSharedPreferences(MY_PREFERENCE_NAME, Context.MODE_PRIVATE);
        return pref.getInt(PREF_STOVE2_KEY, 0);
    }
    ...
    // for  air conditioner temp
    public static void saveAirTemp(Context context, int air_temp) {
        SharedPreferences pref = context.getSharedPreferences(MY_PREFERENCE_NAME, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = pref.edit();
        editor.putInt(PREF_AIR_TEMP_KEY, air_temp);
        editor.apply();
    }
    public static int loadAirTemp(Context context) {
        SharedPreferences pref = context.getSharedPreferences(MY_PREFERENCE_NAME, Context.MODE_PRIVATE);
        return pref.getInt(PREF_AIR_TEMP_KEY, 22);
    }

    // for  switch lamp
    public static void saveSwLampPref(Context context, int sw_lamp) {
        SharedPreferences pref = context.getSharedPreferences(MY_PREFERENCE_NAME, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = pref.edit();
        editor.putInt(PREF_SW_LAMP_KEY, sw_lamp);
        editor.apply();
    }
    public static int loadSwLampPref(Context context) {
        SharedPreferences pref = context.getSharedPreferences(MY_PREFERENCE_NAME, Context.MODE_PRIVATE);
        return pref.getInt(PREF_SW_LAMP_KEY, 0);
    }

    // for  CONTROL ALL ELECTRIC DEVICES
    public static void saveElectricDevices(Context context, int electric_device) {
        SharedPreferences pref = context.getSharedPreferences(MY_PREFERENCE_NAME, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = pref.edit();
        editor.putInt(PREF_ELECTRIC_DEVICES_KEY, electric_device);
        editor.apply();
    }
    public static int loadElectricDevices(Context context) {
        SharedPreferences pref = context.getSharedPreferences(MY_PREFERENCE_NAME, Context.MODE_PRIVATE);
        return pref.getInt(PREF_ELECTRIC_DEVICES_KEY, 0);
    }

    // for  KITCHEN STATE
    public static void saveKitchenState(Context context, int kitchen_state) {
        SharedPreferences pref = context.getSharedPreferences(MY_PREFERENCE_NAME, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = pref.edit();
        editor.putInt(PREF_KITCHEN_STATE_KEY, kitchen_state);
        editor.apply();
    }
    public static int loadKitchenState(Context context) {
        SharedPreferences pref = context.getSharedPreferences(MY_PREFERENCE_NAME, Context.MODE_PRIVATE);
        return pref.getInt(PREF_KITCHEN_STATE_KEY, 0);
    }

    // for  DIMMER KITCHEN STATE
    public static void saveDimmerState(Context context, int dimmer_state) {
        SharedPreferences pref = context.getSharedPreferences(MY_PREFERENCE_NAME, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = pref.edit();
        editor.putInt(PREF_DIMMER_STATE_KEY, dimmer_state);
        editor.apply();
    }
    public static int loadDimmerState(Context context) {
        SharedPreferences pref = context.getSharedPreferences(MY_PREFERENCE_NAME, Context.MODE_PRIVATE);
        return pref.getInt(PREF_DIMMER_STATE_KEY, 0);
    }


    // for changing stove ip address
    public static void saveStoveIp(Context context, String stove_ip) {
        SharedPreferences pref = context.getSharedPreferences(MY_PREFERENCE_NAME, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = pref.edit();
        editor.putString(PREF_STOVE_IP_KEY, stove_ip);
        editor.apply();
    }
    public static String loadStoveIp(Context context) {
        SharedPreferences pref = context.getSharedPreferences(MY_PREFERENCE_NAME, Context.MODE_PRIVATE);
        return pref.getString(PREF_STOVE_IP_KEY, "");
    }
}